defmodule Cldr.Calendar.StrftimeOptions.Test do
  ...
  test "abbreviated day names" do
    assert MyApp.Cldr.Calendar.strftime_options!("en")[:abbreviated_day_of_week_names].(1) == "Mon"
    assert MyApp.Cldr.Calendar.strftime_options!("en")[:abbreviated_day_of_week_names].(7) == "Sun"
    assert MyApp.Cldr.Calendar.strftime_options!("he")[:abbreviated_day_of_week_names].(1) == "יום ב׳"
    assert MyApp.Cldr.Calendar.strftime_options!("he")[:abbreviated_day_of_week_names].(7) == "יום א׳"
  end
