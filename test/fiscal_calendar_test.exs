defmodule Cldr.Calendar.FiscalCalendar.Test do
  ...
  test "US Fiscal dates" do
    ...
    assert Date.convert!(year.first, Cldr.Calendar.Gregorian) == ~D[2020-10-01 Cldr.Calendar.Gregorian]
    assert Date.convert!(year.last, Cldr.Calendar.Gregorian) == ~D[2021-09-30 Cldr.Calendar.Gregorian]
  end
  ...
  test "AU Fiscal dates" do
    ...
    assert Date.convert!(year.first, Cldr.Calendar.Gregorian) == ~D[2021-07-01 Cldr.Calendar.Gregorian]
    assert Date.convert!(year.last, Cldr.Calendar.Gregorian) == ~D[2022-06-30 Cldr.Calendar.Gregorian]
  end
